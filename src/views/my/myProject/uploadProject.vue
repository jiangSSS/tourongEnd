    ...
    <div class="">
        ...
        <div class="tab">
            <van-tabs v-model="active">
                <van-tab title="上传项目信息">
                    <div class="project">
                        <div class="rows heightRows">
                            <div class="rows">
                                <span>
                                    <i style="color:#f00">*</i> 项目标题</span>
                    ...
                    <div class="project">
                        <div v-for="(item , index) in pageList" :key="index" class="invest-item">
                            ...
                            <div class="clearfix titleBox">
                                <div class="title fll" @click="toProjectDetailPage(item.id,item.applyStatus)">
                                    {{item.applyTitle}}
                                </div>
        ...
        methods: {
            ...
            submit(applyStatus) {
                if (this.applyTitle && this.fileList.length != 0) {
                    ...
                    this.$axios.post("/jsp/wap/center/do/doProjectDatumApply.jsp", qs.stringify(params)).then(res => {
                        console.log(res)
                        if (res.success == "true") {
                            if (applyStatus == 0) {
